    ...
    public partial class ProgressReporterDialogue : Form
    {
        ...
        private void RunBackgroundOperation(object o)
        {
            ...
            this.Invoke((MethodInvoker)delegate
         {
            ...
            {
                ShowDoneWithError(null, "  강제 취소됨");
                Running = false;
                Pinoeye.Main.comPort.Close();
                return;
            }
        ...
        private void ShowDoneCancelled()
        {
            this.Invoke((MethodInvoker)delegate
            {
                ...
                this.lblProgressMessage.Text = "접속 취소";
        ...
        {
            var errMessage = doWorkArgs ?? "예기치 않은 오류가 발생하였습니다.";
        ...
        private void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            // * Signal the worker.
            this.btnCancel.Visible = false;
            this.lblProgressMessage.Text = "취소중...";
